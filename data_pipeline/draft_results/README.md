...
stats = collector.collect_draft_results('458.l.6966', 2025, push_to_d1=True)
```
...
### Step 1: Collect Draft Data (Within 24 hours of draft)

```bash
# Run the collector with your league key and season
python -m data_pipeline.draft_results.collector --league_key "458.l.6966" --season 2025
```
...
3. Store in local database with job logging
4. Push directly to Cloudflare D1 (production)

### Step 2: Manually Update Keeper Status
