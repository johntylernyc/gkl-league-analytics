...
# Yahoo stat ID mappings for daily baseball stats
DAILY_STAT_ID_MAP = {
    # Batting stats
    '7': 'runs',          # R
    '8': 'hits',          # H  
    ...
    '60': 'at_bats_hits', # AB/H format (e.g., "3/1" means 3 AB, 1 H)
