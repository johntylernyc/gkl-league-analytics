...
def main():
    ...
    if all_passed:
        ...
        print("\nNext steps:")
        print("1. Add GitHub secrets (see deployment/setup_github_secrets.md)")
        print("2. Deploy CloudFlare Worker (see deployment/setup_cloudflare.md)")
        print("3. Test the system (see deployment/test_deployment.md)")
    else:
        print("\n[WARNING] SOME CHECKS FAILED - Review the issues above")
        print("\nRefer to deployment guides in deployment/ directory")
